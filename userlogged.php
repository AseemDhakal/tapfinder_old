...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<section id="introduction" class="sections">
		...
		<div class="input-group align-search" id= "response_form">      
         ...
         <div id="display" class="text-white">
	...
	<div id="account" class="sections">
		...
		<input type="button" onclick="hideAdd(), changeText()" type="button" class="btn btn-primary" id="addButton" value="Add Building">
		</button>
		...
		<div id="myModal" style = "display: none;">
			...
			<form  method ="POST" action = "userlogged.php">
				...
				<p>
					<label></label>
					Building Name: <input type='text' id='searchOn' class="form-control typeahead" name ="building_name">
				</p>
	...
	echo '<div class="row">';
	echo '	<div  id="tableHead" class="col-sm-3">Building Name</div>';
	echo '	<div  id="tableHead" class="col-sm-3">Room Description</div>';
	echo '	<div  id="tableHead" class="col-sm-2">Room Number</div>';
	echo '	<div  id="tableHead" class="col-sm-3">Delete Building</div>';
	echo '</div>';
